...
const isActiveStyle =
  "group flex items-center px-5 gap-3 text-sky-900 dark:text-slate-50 font-extrabold border-r-2 border-sky-900 dark:border-slate-50 transition-all duration-200 ease-in-out capitalize";
...
const Sidebar = ({ user, closeToggle }) => {
  ...
  return (
    <div className="flex flex-col justify-between bg-sky-200 dark:bg-slate-800 h-full overflow-y-scroll min-w-210 hide-scrollbar">
      <div className="flex flex-col">
        ...
        <div className="flex flex-col gap-5">
          ...
          <h3 className="mt-2 px-5 text-base 2xl:text-xl dark:text-slate-300">
            Discover
          </h3>
