              ...
              {userId === user._id && (
                <GoogleLogout
                  ...
                  render={(renderProps) => (
                    <button
                      type="button"
                      className="ease-in-out duration-100 bg-rose-50 hover:bg-rose-100 hover:shadow-2xl font-bold flex justify-center items-center p-2 rounded-full cursor-pointer outline-none"
